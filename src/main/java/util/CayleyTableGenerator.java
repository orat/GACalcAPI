 ...
 * 
 * Compare with
 * https://github.com/wandelbotsgmbh/geometricalgebra/blob/main/geometricalgebra/cayley.py
 * 
...
public class CayleyTableGenerator {
     ...
     * 
     * determineBasisBlades(3) = <p>
     * [], [1], [2], [3], [1, 2], [1, 3], [2, 3], [1, 2, 3]<p>
     * 
    ...
    /**
     * Sort the given tuple and return  +1 (-1) if the number of swaps of adjacent 
     * elements was even (odd), respectively.
     *
     * Examples:<p>
     * normalize((1,2,3)) = ((1, 2, 3), 1)
     * normalize((1,3,2)) = ((1, 2, 3), -1)
     * normalize((3,2,1)) = ((1, 2, 3), -1)
     * 
     * @return sign
     */
     ...
     *
     * 1. Sort first component numerically by exchanging neighbours and alternate 
     *    sign once for each swap.
     * 2. Reverse sort second component numerically by exchanging neighbours
     *    and alternate sign once for each swap.
     * 3. If the last digit of the first component and first digit of the second 
     *    component match, change sign as appropriate to the square of the compo-
     *    nents and remove.
