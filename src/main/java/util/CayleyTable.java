...
public class CayleyTable extends DenseStringMatrix {
     ...
     * Cell.
     * 
     * A cell of a cayley table can include "0", "1" or other numerical values 
     * with or without a prefix sign or the name of a blade also eventually with
     * a sign a prefix.<p>
     * 
     * In a typical bases blade names list, the "1" is used for the scalor part
     * and it has the index=0 in the list. <p>
     * 
     * @param bladeIndex >=0, if cell includes a blade, the bladeIndex corresponds 
     * with the basis blade index in the basisBladeNames[].
     * 
